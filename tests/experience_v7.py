...
assert 'experience-v7.css' in provider and 'experience-v7-aura.css' in provider, 'Experience v7 styles not wired into app'
...
assert 'auralis-shell-v11' in sw and 'auralis-experience-v7.js' in sw and 'konkani-radio-v7.js' in sw and 'experience-v7.css' in sw and 'experience-v7-aura.css' in sw, 'PWA v11 shell incomplete'

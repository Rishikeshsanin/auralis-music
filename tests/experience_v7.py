...
assert 'auralis-shell-v13' in sw and 'auralis-experience-v7.js' in sw and 'konkani-radio-v7.js' in sw and 'experience-v8-aura.css' in sw, 'PWA v13 shell must retain Experience v7/v8 assets'

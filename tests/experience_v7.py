...
assert 'auralis-shell-v12' in sw and 'auralis-experience-v7.js' in sw and 'konkani-radio-v7.js' in sw and 'experience-v8-aura.css' in sw, 'PWA v12 shell incomplete'

...
assert "import '../auralis-experience-v7.js'" in provider and 'experience-v7.css' in provider, 'Experience v7 not wired into app'
...
assert 'auralis-shell-v11' in sw and 'auralis-experience-v7.js' in sw and 'experience-v7.css' in sw, 'PWA v11 shell incomplete'

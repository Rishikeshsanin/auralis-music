...
assert '#auralis-hls' in provider and '#auralis-hls' in engine, 'directory-flagged HLS fallback marker missing'
...
assert 'auralis-shell-v15' in sw and 'experience-v6.css' in sw and 'radio-reliability-v6.js' in sw, 'Current PWA shell must retain radio v6 assets'

const CACHE='auralis-shell-v10';
const SHELL=[
  './','./index.html','./styles.css','./fixes.css','./experience.css','./experience-v3.css','./experience-v4.css','./experience-v5.css','./experience-v6.css',
  './js/app-v3.js','./js/row-play-targets.js','./js/radio-reliability-v6.js','./js/store.js','./js/fallback.js','./js/collections.js','./js/library-map.js',
